...
features = unique(c(colnames(known_hannigan),colnames(known_yu),colnames(known_vogtmann),colnames(known_zeller),colnames(known_thomas)))
...
write.csv(auc_known_LODO, "/home1/yilingao/proj/abundance/auc_known_LODO/bracken/bracken_test_feng_1000trees.csv")
