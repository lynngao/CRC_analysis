...
features = unique(c(colnames(known_hannigan),colnames(known_feng),colnames(known_vogtmann),colnames(known_zeller),colnames(known_yu)))
...
known_5 = feature_selection(known_zeller)
...
write.csv(auc_known_LODO, "/home1/yilingao/proj/abundance/auc_known_LODO/bracken/bracken_test_thomas_1000trees.csv")
