...
features = unique(c(colnames(known_hannigan),colnames(known_feng),colnames(known_yu),colnames(known_zeller),colnames(known_thomas)))
...
write.csv(auc_known_LODO, "/home1/yilingao/proj/abundance/auc_known_LODO/bracken/bracken_test_vogtmann_1000trees.csv")
