...
features = unique(c(colnames(known_yu),colnames(known_feng),colnames(known_vogtmann),colnames(known_zeller),colnames(known_thomas)))
...
write.csv(auc_known_LODO, "/home1/yilingao/proj/abundance/auc_known_LODO/bracken/bracken_test_hannigan_1000trees.csv")
