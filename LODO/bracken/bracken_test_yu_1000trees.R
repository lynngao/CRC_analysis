...
features = unique(c(colnames(known_hannigan),colnames(known_feng),colnames(known_vogtmann),colnames(known_zeller),colnames(known_thomas)))
...
known_1 = feature_selection(known_hannigan)
known_2 = feature_selection(known_feng)
known_3 = feature_selection(known_vogtmann)
known_4 = feature_selection(known_zeller)
...
write.csv(auc_known_LODO, "/home1/yilingao/proj/abundance/auc_known_LODO/bracken/bracken_test_yu_1000trees.csv")
