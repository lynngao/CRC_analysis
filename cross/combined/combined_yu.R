...
##################################combined auc#################################
y_test_hannigan_combined <- readRDS("/home1/yilingao/proj/abundance/training:yu/y_test_hannigan_combined.rds")
colnames(y_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(y_test_hannigan_combined))] = paste0('u',colnames(y_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(y_test_hannigan_combined))])
y_test_hannigan_combined = y_test_hannigan_combined[rownames(y_test_hannigan_combined)%in%rownames(combined_hannigan),]
y_test_hannigan_combined$status = combined_hannigan$status
y_test_feng_combined <- readRDS("/home1/yilingao/proj/abundance/training:yu/y_test_feng_combined.rds")
y_test_feng_combined = y_test_feng_combined[rownames(y_test_feng_combined)%in%rownames(combined_feng),]
colnames(y_test_feng_combined)[(ncol(known_feng)):(ncol(y_test_feng_combined))] = paste0('u',colnames(y_test_feng_combined)[(ncol(known_feng)):(ncol(y_test_feng_combined))])
y_test_feng_combined$status = combined_feng$status
y_test_thomas_combined <- readRDS("/home1/yilingao/proj/abundance/training:yu/y_test_thomas_combined.rds")
colnames(y_test_thomas_combined)[(ncol(known_thomas)):(ncol(y_test_thomas_combined))] = paste0('u',colnames(y_test_thomas_combined)[(ncol(known_thomas)):(ncol(y_test_thomas_combined))])
y_test_thomas_combined$status = combined_thomas$status
y_test_vogtmann_combined <- readRDS("/home1/yilingao/proj/abundance/training:yu/y_test_vogtmann_combined.rds")
colnames(y_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(y_test_vogtmann_combined))] = paste0('u',colnames(y_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(y_test_vogtmann_combined))])
y_test_vogtmann_combined$status = combined_vogtmann$status
y_test_zeller_combined <- readRDS("/home1/yilingao/proj/abundance/training:yu/y_test_zeller_combined.rds")
colnames(y_test_zeller_combined)[(ncol(known_zeller)):(ncol(y_test_zeller_combined))] = paste0('u',colnames(y_test_zeller_combined)[(ncol(known_zeller)):(ncol(y_test_zeller_combined))])
y_test_zeller_combined = y_test_zeller_combined[rownames(combined_zeller), ]
y_test_zeller_combined$status = combined_zeller$status
...
###################training:yu###########################
combined_yu[,1:(ncol(combined_yu)-1)] = combined_yu[,1:(ncol(combined_yu)-1)]/rowSums(combined_yu[,1:(ncol(combined_yu)-1)]) 
training = combined_yu
...
write.csv(avg_pred1, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/yu/combined_pred_test_hannigan.csv")
write.csv(avg_pred2, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/yu/combined_pred_test_feng.csv")
write.csv(avg_pred3, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/yu/combined_pred_test_vogtmann.csv")
write.csv(avg_pred4, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/yu/combined_pred_test_zeller.csv")
write.csv(avg_pred5, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/yu/combined_pred_test_thomas.csv")

return(auc_cross_cohort)
}


test1 = y_test_hannigan_combined
test2 = y_test_feng_combined
test3 = y_test_vogtmann_combined
test4 = y_test_zeller_combined
test5 = y_test_thomas_combined

auc_cross_cohort <- rf_model(training,test1,test2,test3,test4,test5,auc_cross_cohort)

write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/cross_datasets_combined_yu_5000trees.csv")
