...
##################################combined auc#################################
t_test_vogtmann_combined <- readRDS("/home1/yilingao/proj/abundance/training:thomas/t_test_vogtmann_combined.rds")
colnames(t_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(t_test_vogtmann_combined))] = paste0('u',colnames(t_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(t_test_vogtmann_combined))])
t_test_vogtmann_combined$status = combined_vogtmann$status
t_test_feng_combined <- readRDS("/home1/yilingao/proj/abundance/training:thomas/t_test_feng_combined.rds")
colnames(t_test_feng_combined)[(ncol(known_feng)):(ncol(t_test_feng_combined))] = paste0('u',colnames(t_test_feng_combined)[(ncol(known_feng)):(ncol(t_test_feng_combined))])
t_test_feng_combined = t_test_feng_combined[rownames(t_test_feng_combined)%in%rownames(combined_feng),]
t_test_feng_combined$status = combined_feng$status
t_test_hannigan_combined <- readRDS("/home1/yilingao/proj/abundance/training:thomas/t_test_hannigan_combined.rds")
colnames(t_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(t_test_hannigan_combined))] = paste0('u',colnames(t_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(t_test_hannigan_combined))])
t_test_hannigan_combined = t_test_hannigan_combined[rownames(t_test_hannigan_combined)%in%rownames(combined_hannigan),]
t_test_hannigan_combined$status = combined_hannigan$status
t_test_zeller_combined <- readRDS("/home1/yilingao/proj/abundance/training:thomas/t_test_zeller_combined.rds")
colnames(t_test_zeller_combined)[(ncol(known_zeller)):(ncol(t_test_zeller_combined))] = paste0('u',colnames(t_test_zeller_combined)[(ncol(known_zeller)):(ncol(t_test_zeller_combined))])
t_test_zeller_combined = t_test_zeller_combined[rownames(combined_zeller), ]
t_test_zeller_combined$status = combined_zeller$status
t_test_yu_combined <- readRDS("/home1/yilingao/proj/abundance/training:thomas/t_test_yu_combined.rds")
colnames(t_test_yu_combined)[(ncol(known_yu)):(ncol(t_test_yu_combined))] = paste0('u',colnames(t_test_yu_combined)[(ncol(known_yu)):(ncol(t_test_yu_combined))])
t_test_yu_combined$status = combined_yu$status
...
###################training:thomas###########################
combined_thomas[,1:(ncol(combined_thomas)-1)] = combined_thomas[,1:(ncol(combined_thomas)-1)]/rowSums(combined_thomas[,1:(ncol(combined_thomas)-1)]) 
training = combined_thomas
...
write.csv(avg_pred1, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/thomas/combined_pred_test_yu.csv")
write.csv(avg_pred2, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/thomas/combined_pred_test_hannigan.csv")
write.csv(avg_pred3, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/thomas/combined_pred_test_feng.csv")
write.csv(avg_pred4, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/thomas/combined_pred_test_vogtmann.csv")
write.csv(avg_pred5, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/thomas/combined_pred_test_zeller.csv")

return(auc_cross_cohort)
}


test1 = t_test_yu_combined
test2 = t_test_hannigan_combined
test3 = t_test_feng_combined
test4 = t_test_vogtmann_combined
test5 = t_test_zeller_combined

auc_cross_cohort <- rf_model(training,test1,test2,test3,test4,test5,auc_cross_cohort)

write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/cross_datasets_combined_thomas_5000trees.csv")
