...
training = thomas[1:(ncol(thomas)-1)]
training_status = thomas$status
...
test4 = vogtmann[1:(ncol(vogtmann)-1)]
test4_status = vogtmann$status
test5 = zeller[1:(ncol(zeller)-1)]
test5_status = zeller$status
...
write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/bracken/bracken_thomas_1000trees.csv")
