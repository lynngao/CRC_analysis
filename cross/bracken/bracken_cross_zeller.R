...
training = zeller[1:(ncol(zeller)-1)]
training_status = zeller$status
...
write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/bracken/bracken_zeller_1000trees.csv")
