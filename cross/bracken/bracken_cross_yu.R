...
training = yu[1:(ncol(yu)-1)]
training_status = yu$status
test1 = hannigan[1:(ncol(hannigan)-1)]
test1_status = hannigan$status
...
write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/bracken/bracken_yu_1000trees.csv")
