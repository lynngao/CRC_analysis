...
training = hannigan[1:(ncol(hannigan)-1)]
training_status = hannigan$status
test1 = yu[1:(ncol(yu)-1)]
test1_status = yu$status
test2 = feng[1:(ncol(feng)-1)]
test2_status = feng$status
test3 = vogtmann[1:(ncol(vogtmann)-1)]
test3_status = vogtmann$status
...
write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/bracken/bracken_hannigan_1000trees.csv")
