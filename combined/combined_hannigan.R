...
##################################combined auc#################################
h_test_feng_combined <- readRDS("/home1/yilingao/proj/abundance/training:hannigan/h_test_feng_combined.rds")
colnames(h_test_feng_combined)[(ncol(known_feng)):(ncol(h_test_feng_combined))] = paste0('u',colnames(h_test_feng_combined)[(ncol(known_feng)):(ncol(h_test_feng_combined))])
h_test_feng_combined = h_test_feng_combined[rownames(h_test_feng_combined)%in%rownames(combined_feng),]
h_test_feng_combined$status = combined_feng$status
h_test_thomas_combined <- readRDS("/home1/yilingao/proj/abundance/training:hannigan/h_test_thomas_combined.rds")
colnames(h_test_thomas_combined)[(ncol(known_thomas)):(ncol(h_test_thomas_combined))] = paste0('u',colnames(h_test_thomas_combined)[(ncol(known_thomas)):(ncol(h_test_thomas_combined))])
h_test_thomas_combined$status = combined_thomas$status
h_test_vogtmann_combined <- readRDS("/home1/yilingao/proj/abundance/training:hannigan/h_test_vogtmann_combined.rds")
colnames(h_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(h_test_vogtmann_combined))] = paste0('u',colnames(h_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(h_test_vogtmann_combined))])
h_test_vogtmann_combined$status = combined_vogtmann$status
h_test_zeller_combined <- readRDS("/home1/yilingao/proj/abundance/training:hannigan/h_test_zeller_combined.rds")
colnames(h_test_zeller_combined)[(ncol(known_zeller)):(ncol(h_test_zeller_combined))] = paste0('u',colnames(h_test_zeller_combined)[(ncol(known_zeller)):(ncol(h_test_zeller_combined))])
h_test_zeller_combined = h_test_zeller_combined[rownames(combined_zeller), ]
h_test_zeller_combined$status = combined_zeller$status
h_test_yu_combined <- readRDS("/home1/yilingao/proj/abundance/training:hannigan/h_test_yu_combined.rds")
colnames(h_test_yu_combined)[(ncol(known_yu)):(ncol(h_test_yu_combined))] = paste0('u',colnames(h_test_yu_combined)[(ncol(known_yu)):(ncol(h_test_yu_combined))])
h_test_yu_combined$status = combined_yu$status

auc_cross_cohort = as.data.frame(matrix(NA,ncol = 5, nrow = 32))
colnames(auc_cross_cohort) = c("training:hannigan, test:yu", "training:hannigan, test:feng", "training:hannigan, test:vogtmann", "training:hannigan, test:zeller","training:hannigan, test:thomas")
rownames(auc_cross_cohort) = c(1:30,"mean","sd")

###################training: hannigan###########################
combined_hannigan[,1:(ncol(combined_hannigan)-1)] = combined_hannigan[,1:(ncol(combined_hannigan)-1)]/rowSums(combined_hannigan[,1:(ncol(combined_hannigan)-1)]) 
training = combined_hannigan
...
write.csv(avg_pred1, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/combined_pred_test_yu.csv")
write.csv(avg_pred2, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/combined_pred_test_feng.csv")
write.csv(avg_pred3, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/combined_pred_test_vogtmann.csv")
write.csv(avg_pred4, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/combined_pred_test_zeller.csv")
write.csv(avg_pred5, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/combined_pred_test_thomas.csv")

return(auc_cross_cohort)
}


test1 = h_test_yu_combined
test2 = h_test_feng_combined
test3 = h_test_vogtmann_combined
test4 = h_test_zeller_combined
test5 = h_test_thomas_combined

auc_cross_cohort <- rf_model(training,test1,test2,test3,test4,test5,auc_cross_cohort)

write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/cross_datasets_combined_hannigan_5000trees.csv")
