...
##################################combined auc#################################
f_test_hannigan_combined <- readRDS("/home1/yilingao/proj/abundance/training:feng/f_test_hannigan_combined.rds")
colnames(f_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(f_test_hannigan_combined))] = paste0('u',colnames(f_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(f_test_hannigan_combined))])
f_test_hannigan_combined = f_test_hannigan_combined[rownames(f_test_hannigan_combined)%in%rownames(combined_hannigan),]
f_test_hannigan_combined$status = combined_hannigan$status
f_test_thomas_combined <- readRDS("/home1/yilingao/proj/abundance/training:feng/f_test_thomas_combined.rds")
colnames(f_test_thomas_combined)[(ncol(known_thomas)):(ncol(f_test_thomas_combined))] = paste0('u',colnames(f_test_thomas_combined)[(ncol(known_thomas)):(ncol(f_test_thomas_combined))])
f_test_thomas_combined$status = combined_thomas$status
f_test_vogtmann_combined <- readRDS("/home1/yilingao/proj/abundance/training:feng/f_test_vogtmann_combined.rds")
colnames(f_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(f_test_vogtmann_combined))] = paste0('u',colnames(f_test_vogtmann_combined)[(ncol(known_vogtmann)):(ncol(f_test_vogtmann_combined))])
f_test_vogtmann_combined$status = combined_vogtmann$status
f_test_zeller_combined <- readRDS("/home1/yilingao/proj/abundance/training:feng/f_test_zeller_combined.rds")
colnames(f_test_zeller_combined)[(ncol(known_zeller)):(ncol(f_test_zeller_combined))] = paste0('u',colnames(f_test_zeller_combined)[(ncol(known_zeller)):(ncol(f_test_zeller_combined))])
f_test_zeller_combined = f_test_zeller_combined[rownames(combined_zeller), ]
f_test_zeller_combined$status = combined_zeller$status
f_test_yu_combined <- readRDS("/home1/yilingao/proj/abundance/training:feng/f_test_yu_combined.rds")
colnames(f_test_yu_combined)[(ncol(known_yu)):(ncol(f_test_yu_combined))] = paste0('u',colnames(f_test_yu_combined)[(ncol(known_yu)):(ncol(f_test_yu_combined))])
f_test_yu_combined$status = combined_yu$status

auc_cross_cohort = as.data.frame(matrix(NA,ncol = 5, nrow = 32))
colnames(auc_cross_cohort) = c("training:feng, test:yu", "training:feng, test:hannigan", "training:feng, test:vogtmann", "training:feng, test:zeller","training:feng, test:thomas")
rownames(auc_cross_cohort) = c(1:30,"mean","sd")

###################training:feng###########################
combined_feng[,1:(ncol(combined_feng)-1)] = combined_feng[,1:(ncol(combined_feng)-1)]/rowSums(combined_feng[,1:(ncol(combined_feng)-1)]) 
training = combined_feng
...
write.csv(avg_pred1, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/feng/combined_pred_test_yu.csv")
write.csv(avg_pred2, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/feng/combined_pred_test_hannigan.csv")
write.csv(avg_pred3, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/feng/combined_pred_test_vogtmann.csv")
write.csv(avg_pred4, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/feng/combined_pred_test_zeller.csv")
write.csv(avg_pred5, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/feng/combined_pred_test_thomas.csv")

return(auc_cross_cohort)
}


test1 = f_test_yu_combined
test2 = f_test_hannigan_combined
test3 = f_test_vogtmann_combined
test4 = f_test_zeller_combined
test5 = f_test_thomas_combined

auc_cross_cohort <- rf_model(training,test1,test2,test3,test4,test5,auc_cross_cohort)

write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/cross_datasets_combined_feng_5000trees.csv")
