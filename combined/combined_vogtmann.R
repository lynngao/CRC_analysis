...
##################################combined auc#################################
v_test_thomas_combined <- readRDS("/home1/yilingao/proj/abundance/training:vogtmann/v_test_thomas_combined.rds")
colnames(v_test_thomas_combined)[(ncol(known_thomas)):(ncol(v_test_thomas_combined))] = paste0('u',colnames(v_test_thomas_combined)[(ncol(known_thomas)):(ncol(v_test_thomas_combined))])
v_test_thomas_combined$status = combined_thomas$status
v_test_feng_combined <- readRDS("/home1/yilingao/proj/abundance/training:vogtmann/v_test_feng_combined.rds")
colnames(v_test_feng_combined)[(ncol(known_feng)):(ncol(v_test_feng_combined))] = paste0('u',colnames(v_test_feng_combined)[(ncol(known_feng)):(ncol(v_test_feng_combined))])
v_test_feng_combined = v_test_feng_combined[rownames(v_test_feng_combined)%in%rownames(combined_feng),]
v_test_feng_combined$status = combined_feng$status
v_test_hannigan_combined <- readRDS("/home1/yilingao/proj/abundance/training:vogtmann/v_test_hannigan_combined.rds")
colnames(v_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(v_test_hannigan_combined))] = paste0('u',colnames(v_test_hannigan_combined)[(ncol(known_hannigan)):(ncol(v_test_hannigan_combined))])
v_test_hannigan_combined = v_test_hannigan_combined[rownames(v_test_hannigan_combined)%in%rownames(combined_hannigan),]
v_test_hannigan_combined$status = combined_hannigan$status
v_test_zeller_combined <- readRDS("/home1/yilingao/proj/abundance/training:vogtmann/v_test_zeller_combined.rds")
colnames(v_test_zeller_combined)[(ncol(known_zeller)):(ncol(v_test_zeller_combined))] = paste0('u',colnames(v_test_zeller_combined)[(ncol(known_zeller)):(ncol(v_test_zeller_combined))])
v_test_zeller_combined = v_test_zeller_combined[rownames(combined_zeller), ]
v_test_zeller_combined$status = combined_zeller$status
v_test_yu_combined <- readRDS("/home1/yilingao/proj/abundance/training:vogtmann/v_test_yu_combined.rds")
colnames(v_test_yu_combined)[(ncol(known_yu)):(ncol(v_test_yu_combined))] = paste0('u',colnames(v_test_yu_combined)[(ncol(known_yu)):(ncol(v_test_yu_combined))])
v_test_yu_combined$status = combined_yu$status
...
###################training:vogtmann###########################
combined_vogtmann[,1:(ncol(combined_vogtmann)-1)] = combined_vogtmann[,1:(ncol(combined_vogtmann)-1)]/rowSums(combined_vogtmann[,1:(ncol(combined_vogtmann)-1)]) 
training = combined_vogtmann
...
write.csv(avg_pred1, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/vogtmann/combined_pred_test_yu.csv")
write.csv(avg_pred2, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/vogtmann/combined_pred_test_hannigan.csv")
write.csv(avg_pred3, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/vogtmann/combined_pred_test_feng.csv")
write.csv(avg_pred4, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/vogtmann/combined_pred_test_zeller.csv")
write.csv(avg_pred5, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/vogtmann/combined_pred_test_thomas.csv")

return(auc_cross_cohort)
}


test1 = v_test_yu_combined
test2 = v_test_hannigan_combined
test3 = v_test_feng_combined
test4 = v_test_zeller_combined
test5 = v_test_thomas_combined

auc_cross_cohort <- rf_model(training,test1,test2,test3,test4,test5,auc_cross_cohort)

write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/cross_datasets_combined_vogtmann_5000trees.csv")
