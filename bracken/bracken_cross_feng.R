...
training = feng[1:(ncol(feng)-1)]
training_status = feng$status
...
write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/bracken/bracken_feng_1000trees.csv")
