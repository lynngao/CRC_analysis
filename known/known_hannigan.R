...
#write.csv(avg_pred, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/known_pred_test_yu.csv")
...
avg_pred = avg_pred/30
#write.csv(avg_pred, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/known_pred_test_feng.csv")
...
avg_pred = avg_pred/30
#write.csv(avg_pred, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/known_pred_test_vogtmann.csv")
...
avg_pred = avg_pred/30
#write.csv(avg_pred, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/known_pred_test_zeller.csv")
...
avg_pred = avg_pred/30
#write.csv(avg_pred, "/home1/yilingao/proj/abundance/auc_cross_datasets/pred/hannigan/known_pred_test_thomas.csv")
...
write.csv(auc_cross_cohort, "/home1/yilingao/proj/abundance/auc_cross_datasets/1000trees/cross_datasets_known_hannigan_1000trees.csv")
